...
class AboutPanel(ctk.CTkFrame):
 def __init__(self,parent,**kwargs):
  ...
  ctk.CTkLabel(scroll,text="Acerca de Asistente ONG",font=FONTS["title"],text_color=COLORS["text"]).pack(anchor="w"); ctk.CTkLabel(scroll,text="NubiWorks · tecnología offline para apoyo social",font=FONTS["subheading"],text_color=COLORS["primary"]).pack(anchor="w",pady=(4,18))
