...
class AboutPanel(ctk.CTkFrame):
 def __init__(self,parent,**kwargs):
  ...
  self._section(scroll,"EL PROYECTO","Asistente ONG es una herramienta de escritorio orientada a organizaciones sociales, fundaciones y equipos de asistencia que reciben relatos, consultas o situaciones que necesitan ser ordenadas y priorizadas. El sistema ayuda a estructurar la información, detectar indicadores contextuales, sugerir preguntas de seguimiento, organizar recursos y preparar borradores de trabajo.")
  self._section(scroll,"¿CÓMO FUNCIONA?","El flujo está pensado para ser simple: se ingresa el relato, el motor local analiza el contexto, clasifica de forma orientativa la prioridad, muestra los indicadores detectados, propone preguntas pendientes y relaciona el caso con recursos disponibles. El profesional revisa el resultado y toma la decisión final.")
  self._section(scroll,"PRIVACIDAD Y MODO OFFLINE","El proyecto está diseñado para funcionar localmente y reducir la necesidad de enviar información sensible a servicios externos. La aplicación utiliza almacenamiento local y reglas de procesamiento explicables. Offline no significa que una organización deba omitir sus protocolos: cada caso debe seguir sus procedimientos profesionales y legales.")
  self._section(scroll,"QUÉ INCLUYE","• Triaje contextual y explicable\n• Gestión local de casos\n• Dashboard y estadísticas\n• Búsqueda y filtros de recursos\n• Generación de informes sociales\n• Configuración de la institución y profesional\n• Ayuda y orientación de uso\n• Base local de recursos\n• Interfaz clara y accesible\n• Preparación para distribución como aplicación Windows")
  self._section(scroll,"QUÉ NO HACE","No diagnostica, no reemplaza profesionales, no confirma por sí solo una emergencia, no determina responsabilidades legales y no debe utilizarse como única fuente para decisiones de alto impacto. Sus resultados son asistencia orientativa para organizar información.")
  self._section(scroll,"SOBRE NUBIWORKS","NubiWorks es mi proyecto y marca tecnológica, actualmente en proceso de formación. La idea de NubiWorks es crear software accesible, privado y útil, especialmente herramientas que puedan funcionar con recursos limitados y generar impacto social.")
  self._section(scroll,"SOBRE LA CREADORA","Mi nombre es Sarah Lee Olivera y soy una estudiante y desarrolladora de software de Argentina apasionada por crear tecnología con impacto social. Creo que la inteligencia artificial debe ser una herramienta para asistir a las personas, proteger su privacidad y facilitar el trabajo de quienes ayudan a otros. Mi interés se centra en aplicaciones, inteligencia artificial local (offline), accesibilidad y herramientas que puedan utilizarse en distintos contextos, incluso donde los recursos son limitados. Este software es un proyecto de código abierto orientado al bien común: busca apoyar a profesionales y voluntarios, nunca reemplazar su criterio ni la atención humana.")
