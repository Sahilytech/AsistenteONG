...
class ConfigPanel(ctk.CTkFrame):
    ...
    def _setup_ui(self):
        ...
        ctk.CTkLabel(card,text="Sistema usa la apariencia de Windows; Claro y Oscuro fijan el modo. Reiniciá la aplicación después de cambiar para aplicar toda la paleta.",font=FONTS["small"],text_color=COLORS["text_muted"],wraplength=720,justify="left").pack(anchor="w",padx=18,pady=(0,10))
        ...
        ctk.CTkLabel(privacy,text="Privacidad",font=FONTS["heading"],text_color=COLORS["text"]).pack(anchor="w",padx=18,pady=(16,4)); ctk.CTkLabel(privacy,text="MODO OFFLINE · sin búsquedas web · sin envío de relatos a servidores · almacenamiento local.",font=FONTS["body"],text_color=COLORS["success"]).pack(anchor="w",padx=18,pady=(0,16))
        ...
        ctk.CTkLabel(info,text="Herramientas locales",font=FONTS["heading"],text_color=COLORS["text"]).pack(anchor="w",padx=18,pady=(16,8)); ctk.CTkLabel(info,text="Triaje orientativo · gestión de casos · seguimiento · informes · recursos · biblioteca · agenda · copias de seguridad.",font=FONTS["body"],text_color=COLORS["text_muted"],wraplength=720,justify="left").pack(anchor="w",padx=18,pady=(0,18))
    def _theme_changed(self,value):
        if value=="Oscuro": switch_theme("dark"); ctk.set_appearance_mode("dark")
        elif value=="Claro": switch_theme("light"); ctk.set_appearance_mode("light")
        else: switch_theme("light"); ctk.set_appearance_mode("system")
