...
class SplashScreen:
    def __init__(self,on_complete=None):
        ...
        self._particles=[]; self._pulse_nodes=[]; self._rings=[]; self._logo_y=190; self._animation_tick=0
    ...
    def start_loading(self):
        ...
        def step(i=0):
            if i>=len(steps): self.root.after(1200,self._finish); return
            p,t=steps[i]; self.update_progress(p,t); self.root.after(950 if p<100 else 1200,lambda:step(i+1))
        self._animate(); step()
