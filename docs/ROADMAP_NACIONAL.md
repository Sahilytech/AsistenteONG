...
- [ ] Integrar el perfil nuevo al flujo visual de alta y análisis.
- [ ] Tests de regresión para falsos positivos.

## Fase 2 — Caso + Informe + Seguimiento
- [x] Informe social persistido dentro del caso.
- [x] Estructura base de timeline.
- [ ] Genograma visual.
- [ ] Plan de intervención.
- [ ] Derivaciones con estados.
- [ ] Próxima acción y vencimientos.
- [ ] Historial completo de cambios.

## Fase 3 — Cobertura Argentina
...
- [ ] Fecha y fuente obligatoria para cada recurso.
...
## Fase 6 — Documentos y trabajo profesional
...
## Fase 7 — Analítica y capacitación
